...
ROOMS = {
    ...
    'hall': {
        ...
        'exits': {'south': 'entrance', 'west': 'library', 'north': 'treasure_room', 'east': 'storeroom'}, 
        'items': [],
    ...
    # Мои комнаты:
    'storeroom': {
        'description': 'Кладовая забита ящиками, все валяется, но почти ничего нельзя достать', 
        'exits': {'west': 'hall', 'south': 'trap_room', 'east': 'tomb'},
        'items': ['old_armor'],
        'puzzle': None
    },
    'tomb': {
